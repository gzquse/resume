...
\hspace{1.4em}Hi:) I am currently a PhD student at Texas Tech University and a research
affiliate at Lawrence Berkeley National Lab trained as a Quantum, HPC, LLM, and
QEC researcher specializing in 256-node Perlmutter simulations and IBM/IonQ QPUs
and Stim stabilizers; I have developed arithmetic quantum algorithms and block
quantum encoding, large language models/agentic systems, and NP-hard
optimization; my strengths lie in experimental and mathematical rigor, coding,
analysis, communication, and cross-disciplinary collaboration. My mentors are
Jan Balewski (CA), Alex Khan (MD, DC), Steven Rayan (Usask), and Ziwen Pan
(TX, AZ).

\vspace{0.15cm}
\noindent\textbf{Keywords for my research:} quantum information (encoding),
computing (QAOA), stabilisation method (surface code \& QLDPC), cryptography
